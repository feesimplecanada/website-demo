...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    if (isset($_POST['action']) and $_POST['action'] === 'subscribe') {
        $email = $_POST["email"];
        $subject = "Inquiry Email"; // Replace your Subject Here
        $to = "calvinfindley@gmail.com.com"; // Replace your Email Here
        $headers = "From: $email\r\n";
        ...
        $to = "calvinfindley@gmail.com"; // Replace your Email Here
        $headers = "From: $email\r\n";
        $headers .= "Reply-To: $email\r\n";
        $headers .= "Content-type: text/html\r\n";
